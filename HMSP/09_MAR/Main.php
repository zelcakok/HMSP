...
$(document).ready(function() {
	...
	function update(){	 
	  var i; 
	  var id="#tabDropDownOne";
	  if ($("#tabDropDownOne1").hasClass("active")) i=1;
	  else if ($("#tabDropDownOne2").hasClass("active")) i=2; 
	  else if ($("#tabDropDownOne3").hasClass("active")) i=3;
