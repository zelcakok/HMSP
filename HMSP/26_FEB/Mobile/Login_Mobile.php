...
<div class="content" id="login">
  ...
  <table align="center" border="0" width="80%">
    ...
    <form action="../lib/connect.php" method="POST" role="form">
    ...
    <pre id="errmsg" style="vertical-align:middle; color:red; clear:left; width:auto; height:auto; border:none; background-color:transparent;"><?php echo $_GET["msg"]; ?></pre>
    </form>
  </td>
  </tr>
  </table>  
